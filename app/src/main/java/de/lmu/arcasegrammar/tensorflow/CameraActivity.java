/*
 * This code is a modified version of the corresponding class CameraActivity defined in
 * https://github.com/tensorflow/examples/tree/master/lite/examples/object_detection/android
 * Copyright 2019 The TensorFlow Authors
 *
 * Modifications:
 * - removed methods that were not necessary for this project:
 *   (lifecycle activities that only contained log calls, getLuminanceStride, getLuminance, getLuminanceStride, setNumThreads)
 * - removed layout components
 * - updated preview size
 * - updated onRequestPermissionsResult
 * - removed logger
 *
...
package de.lmu.arcasegrammar.tensorflow;
